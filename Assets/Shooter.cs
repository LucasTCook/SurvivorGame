...
public class Shooter : MonoBehaviour
{
    ...
    public float cooldown = .25f; // The interval between shots (in seconds)
    public float projectileSpeed = 30; // The speed of the projectile
    ...
    void Update()
    {
        ...
        if (Time.time > lastFireTime + (cooldown - playerController.cooldownReduction))
        {
           ...
           GameObject[] enemies = GameObject.FindGameObjectsWithTag("6");
